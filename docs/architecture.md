...
A mutable session can publish refreshed context as pending reconciliation, but only the bound executor can acknowledge it; a completed immutable outcome requires a revised session and explicit supersession after a later delta.
