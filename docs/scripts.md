...
| `fm-alignment.sh`        | Check alignment barriers, preserve legacy direct reports, and validate alignment outcomes |
...
| `fm-secondmate-report.sh` | Append correlated parent reports or keyed uncorrelated direct-alignment pointers |
...
| `fm-forge-capability-lib.sh` | Resolve project forge providers, local read/write capability, provider tools, and provider-specific authentication |
